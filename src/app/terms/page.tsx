    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white">
        <div className="max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <p>
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.getwishfoundation.in ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>
          <p>
            The Platform is owned by 9205221482, a company incorporated under the Companies Act, 1956 with its registered office at 20B SUBEDARGUNJ, ALLAHABAD UP 211001 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
          </p>
          <p>
