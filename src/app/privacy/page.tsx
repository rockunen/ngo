    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white">
        <div className="max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Sharing</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Security Precautions</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Data Deletion and Retention</h2>
          <p>
